...
document.querySelector("#desc-input").addEventListener("input",(data)=>{
  ...
  var suggest = document.querySelectorAll(".suggest-video")
...
document.querySelector("#menu-icon").addEventListener("click", function () {
  if (flag == 1) {
    ...
    document.querySelector("#left-content").style.left = "-20%"
    flag = 1
  }
})
var flagg = 1
document.querySelector(".icons .menu-btn").addEventListener("click", function () {
  if (flagg == 1) {
